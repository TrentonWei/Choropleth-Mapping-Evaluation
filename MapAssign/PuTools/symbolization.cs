...
namespace MapAssign.PuTools
{
    ...
    {
        #region polygon符号化
        public object PolygonSymbolization(int width, int LineRgbRed, int LineRgbGreen, int LineRgbBlue, esriSimpleLineStyle symbolstyle, int FillRgbRed, int FillRgbGreen, int FillRgbBlue)
        {
